...
from apps.character.apps import CharacterStats, CharacterBag, SecondaryStats, DefenceAndVulnerabilityDamage,\
...
from apps.character.apps import Skills, WeaponMastery
from apps.character.apps import Currency
from apps.character.apps import disable_for_loaddata
